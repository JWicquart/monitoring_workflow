...
selected_variables <- c("DatasetID", "Area", "Country", "Archipelago", 
                        ...
                        "Depth", "Year", "Date", "Method", "Observer", "Tax_ID", "Density", "Size")
...
data_site <- read.csv2("./../data/01_raw/data_contributor_2/dataset2b.csv")
...
data_site <- read.csv2("./../data/01_raw/data_contributor_4/dataset4b.csv")
...
data_main <- data_main %>% 
  ...
  mutate(DatasetID = "DATA5",
         ...
         Archipelago = "Fiji Islands") # Add variables absent in data (can be obtained through data contributor)
