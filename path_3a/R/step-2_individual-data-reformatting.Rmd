...
# Main data
data_main <- read_excel("./../data/raw/data_contributor_1/dataset1.xlsx", 
                        sheet = "Main data")

# Substrate code data
data_code <- read_excel("./../data/raw/data_contributor_1/dataset1.xlsx", 
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA1.csv", row.names = FALSE)
...
# Main data
data_main <- read_excel("./../data/raw/data_contributor_2/dataset2.xlsx", 
                        sheet = "Transect")

# Site data
data_site <- read_excel("./../data/raw/data_contributor_2/dataset2.xlsx", 
                        sheet = "Informations")
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA2.csv", row.names = FALSE)
...
data_main <- read_excel("./../data/raw/data_contributor_3/dataset3.xlsx", sheet = 1) %>% 
  mutate(Site = excel_sheets("./../data/raw/data_contributor_3/dataset3.xlsx")[1])
  
# Make a loop to bind all sheets

for(i in 2:length(excel_sheets("./../data/raw/data_contributor_3/dataset3.xlsx"))){
  
  data_main <- read_excel("./../data/raw/data_contributor_3/dataset3.xlsx", sheet = i) %>% 
    mutate(Site = excel_sheets("./../data/raw/data_contributor_3/dataset3.xlsx")[i]) %>% 
    bind_rows(data_main, .)
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA3.csv", row.names = FALSE)
...
# Main data 1
data_main_1 <- read.csv("./../data/raw/data_contributor_4/dataset4a.csv", sep = ";")

# Main data 2
data_main_2 <- read.csv("./../data/raw/data_contributor_4/dataset4b.csv", sep = ";")

# Substrate code
data_code <- read.csv("./../data/raw/data_contributor_4/dataset4c.csv", sep = ";")
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA4.csv", row.names = FALSE)
...
# Main data
data_main <- read_excel("./../data/raw/data_contributor_5/dataset5a.xlsx", sheet = "Sheet1")

# Site data
data_site <- read_excel("./../data/raw/data_contributor_5/dataset5c.xlsx", sheet = "Coordinates")
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA5.1.csv", row.names = FALSE)
...
# Main data
data_main <- read_excel("./../data/raw/data_contributor_5/dataset5b.xlsx", sheet = "Sheet1")
...
write.csv2(data_main, "./../data/reformatted/01-reformatted_DATA5.2.csv", row.names = FALSE)
